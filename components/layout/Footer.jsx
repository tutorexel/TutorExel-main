...
const iconFacebook = '/icons/icon-facebook.svg';
const iconInstagram = '/icons/icon-instagram.svg';
        ...
        <Container>
          <Row className="g-5">
            ...
            <Col lg={3} md={4}>
              ...
              <Link href="/about-us" className="text-white-50 text-decoration-none mb-2 d-block">About Us</Link>
              <Link href="/careers" className="text-white-50 text-decoration-none mb-2 d-block">Careers</Link>
              <Link href="/blog" className="text-white-50 text-decoration-none mb-2 d-block">Blogs</Link>
              <Link href="/contact" className="text-white-50 text-decoration-none mb-2 d-block">Enroll Now</Link>
              <Link href="/term-condition" className="text-white-50 text-decoration-none mb-2 d-block">Terms and Conditions</Link>
              <Link href="/privacy-policy" className="text-white-50 text-decoration-none mb-2 d-block">Privacy Policy</Link>
              <Link href="/refund-and-cancellation-policy" className="text-white-50 text-decoration-none mb-2 d-block">Refund & Cancellation Policy</Link>
            </Col>
          ...
          <p className="text-center text-white-50 small">
            © {new Date().getFullYear()} TutorExel LLP. TutorExel is a brand owned and operated by TutorExel LLP. All rights reserved.
          </p>
        </Container>
      </footer>
