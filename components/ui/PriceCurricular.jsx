...
const PriceCurricular = ({ title, price1, price2 }) => {
  return (
    ...
    `}</style>
    <Card className="price-circular pricing-box flex-fill d-flex flex-column shadow-sm">
      <Card.Body>
        <Row>
          {/* Left Side */}
          <Col md={8}>
            ...
            <div className="mt-4">
              <p className="pricing-label">Piano</p>
            ...
            <div className="mt-3">
              <p className="pricing-label">Guitar</p>
              <p className="pricing-price">
...
export default PriceCurricular;
