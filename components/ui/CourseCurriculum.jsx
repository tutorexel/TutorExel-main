    ...
    <section id="curriculum-section" className="curriculum-section">
      <Container>
        ...
        <div id="naplan-box" className="naplan-box">
          ...
          <div className="btn-row">
            <Link href="/naplan/year-3/english" passHref><Button className="subject-btn white-btn">English</Button></Link>
            <Link href="/naplan/year-3/maths" passHref><Button className="subject-btn white-btn">Maths</Button></Link>
          </div>
        </div>
      </Container>
    </section>
