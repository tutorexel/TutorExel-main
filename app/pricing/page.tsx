...
const icon1 = "/icons/icon-price-list1.png";
const icon2 = "/icons/icon-price-list2.png";
const icon3 = "/icons/icon-price-list3.png";
const icon4 = "/icons/icon-price-list4.png";
...
const Pricing = () => {
  const [activeLayout, setActiveLayout] = useState<number | null>(null);
          ...
          <Row className="">
            <Col lg={11}>
              ...
              <p className="page-intro mt-3 text-secondary">
                Every family begins with a free trial class so you can
                experience Tutorexel with no commitment. After your trial, you
                can choose either One-to-One Tutoring or Group Classes. All
                sessions are 1 hour. Payments are billed monthly in advance.
              ...
              >
                <Card.Body className="d-flex flex-column">
                  ...
                  <h5 className="mb-3" style={{ color: `#FFF` }}>
                    <u>NAPLAN Bootcamp (Live Classes)</u>
                  </h5>
                  <ul className="feature-list flex-grow-1">
                    {fourthCard.map((item, index) => (
                      <li key={index}>
                        <img src={icon4} className="feature-icon" alt="icon" />
                        {item.title}
                      </li>
                    ))}
                  </ul>
                  <h5 className="mb-3 mt-4" style={{ color: `#FFF` }}>
                    <u>NAPLAN Bootcamp (Self Study)</u>
                  </h5>
                  <ul className="feature-list flex-grow-1">
