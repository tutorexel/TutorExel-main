...
const teacherMagnifyingGlass = "/images/teacher-magnifying-glass.png";
const teacherOkBlueBg = "/images/teacher-ok.png";
const iconFlexibleHours = "/icons/icon-flexible-hours.svg";
const iconTeachAnywhere = "/icons/icon-teach-anywhere.svg";
const iconPreStructured = "/icons/icon-pre-structured.svg";
const iconPurposeDriven = "/icons/icon-purpose-driven.svg";
const iconApplyClick = "/icons/icon-apply-click.svg";
const iconApplyUpload = "/icons/icon-apply-upload.svg";
const iconApplyContact = "/icons/icon-apply-contact.svg";
const iconTeamLogo = "/icons/icon-team-logo.svg";
const arrowSeparator = "/icons/arrow-separator.svg";
...
const whatWeLookForFeatures = [
  ...
  {
    text: "Teaching or tutoring experience with school-aged children",
    bold: "",
  },
...
const whyJoinCards = [
  ...
  {
    icon: iconTeachAnywhere,
    title: "Teach from anywhere",
    description: "with full tech and admin support",
  },
  {
    icon: iconPreStructured,
    title: "Pre-structured content",
    description: "and student progress tools provided",
  },
  {
    icon: iconPurposeDriven,
    title: "Be part of a purpose-driven,",
    description: "educator-first team",
  },
];
...
const howToApplySteps = [
  {
    icon: iconApplyClick,
    title: "",
    description: "Click the button below to fill out the application form",
  },
  {
    icon: iconApplyUpload,
    title: "",
    description: (
      <>
        Upload your <strong>CV</strong> and a <strong>1-minute video</strong>{" "}
        introducing yourself
      </>
    ),
  },
  {
    icon: iconApplyContact,
    title: "",
    description: (
      <>
        We'll get in touch within <strong>3-5 business days</strong> if
        shortlisted
      </>
    ),
  },
  ...
  return (
    <main>
      ...
      <section className="py-5 bg-white">
        <Container>
          <Col lg={11} className="">
            <h4 className="fw-bold mt-3" style={{ fontWeight: "700" }}>
              Make a Real Impact - From Anywhere
            </h4>
            <p className="mt-3 page-intro text-secondary">
              At Tutorexel, we're on a mission to redefine online tutoring for
              school students by combining academic rigour with personalised
              care. If you're passionate about education and want the freedom to
              work from anywhere, join our growing team of expert educators.
            </p>
          </Col>
        </Container>
      </section>
        ...
        <Container>
          ...
          <Col lg={11} className="">
            ...
            <h4 className="fw-bold">
              Online Tutors – All Subjects (Years 2-10)
            </h4>
        ...
        content={
          <div className="text-white">
            ...
            <ul className="fs-5 ps-3 mt-4">
              <li>
                Deliver live, engaging sessions aligned to the Australian
                Curriculum
              </li>
      ...
      <section className="py-5 bg-white">
        <Container>
          ...
          <div className="life-quote-card">
            <h3
              className="fw-normal p-4"
              style={{ color: "white", textAlign: "center" }}
            >
              "We're building a team of educators who genuinely care. At
              Tutorexel, you get the support and flexibility you need to do your
              best work."
            </h3>
          </div>
