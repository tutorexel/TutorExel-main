...
export const naplanData = {
    "year-3": {
        "maths": {
            ...
            introP1: "At TutorExel, our Year 3 NAPLAN Maths program builds a strong foundation in number skills, operations, early fractions, and patterns. Lessons are tailored to your child’s pace and aligned with the Australian Curriculum Year 3 NAPLAN Maths.",
            introP2: "Tutoring is delivered through <strong>1-on-1 or group online sessions</strong>, guided by expert Year 3 NAPLAN Maths tutors who focus on real progress.",
            term:{
                    topics: [
                        {
                            name: "Number Sense & Place Value (Up to 10,000)",
                            description: "Reading, writing, comparing, and ordering numbers to 10,000, understanding place value, number lines, and estimation using Year 3 benchmarks."
                        },
                        {
                            name: "Addition & Subtraction Strategies",
                            description: "Mental and written strategies for addition and subtraction, including regrouping, missing numbers, inverse operations, and word problems."
                        },
                        {
                            name: "Multiplication as Equal Groups",
                            description: "Understanding multiplication through equal groups, arrays, repeated addition, pictures, and simple word problems."
                        },
                        {
                            name: "Division & Sharing Problems",
                            description: "Division as sharing and grouping, including remainders, diagrams, and choosing correct number sentences."
                        },
                        {
                            name: "Fractions in Everyday Contexts",
                            description: "Recognising halves, thirds, and quarters through shading, sharing, and fractions of collections."
                        },
                        {
                            name: "Patterns & Number Sequences",
                            description: "Identifying number and shape patterns, skip counting, missing terms, and recognising pattern rules."
                        },
                        {
                            name: "Measurement: Length, Mass & Capacity",
                            description: "Comparing, estimating, and measuring using centimetres, kilograms, litres, and visual measurement reasoning."
                        },
                        {
                            name: "Time & Calendars",
                            description: "Reading clocks (hour, half-hour, quarter-hour), using calendars, and calculating days before or after events."
                        },
                        {
                            name: "Money & Financial Maths",
                            description: "Recognising coins and notes, counting money, making amounts, calculating change, and solving shopping problems."
                        },
                        {
                            name: "Geometry: 2D & 3D Shapes",
                            description: "Identifying and comparing 2D and 3D shapes, faces and edges, nets, and visualisation tasks."
                        },
                        {
                            name: "Data & Graph Interpretation",
                            description: "Reading picture graphs, column graphs, and tables to compare data and answer reasoning questions."
                        },
                        {
                            name: "Spatial Reasoning & Test Strategies",
                            description: "Working with maps, grids, directions, visual logic, and applying NAPLAN test-taking strategies."
                        },
                    ]
                },
            ...
            sidebar: {
                ...
                subtitle: "Personalised Online Tutoring by trained teachers familiar with the Australian curriculum Year 3 NAPLAN Maths, trusted by parents looking for the best Year 3 NAPLAN Maths tutor Australia wide.",
                ...
                description: "All topics align with Australian Curriculum Maths Year 3 and are taught by experienced Year 3 NAPLAN Maths tutors."
            },
        
        },
        "english": {
            pageTitle: "Year 3 NAPLAN English – Personalised Online Tutoring",
            introHeading: "We've Got the Curriculum Covered",
    ...
    "year-5": {
        "maths": {
            ...
            introHeading: "We've Got the Curriculum Covered",
            introP1: "At TutorExel, our Year 5 NAPLAN Maths program builds a strong foundation in number skills, operations, early fractions, and patterns. Lessons are tailored to your child’s pace and aligned with the Australian Curriculum Year 5 NAPLAN Maths.",
            introP2: "Tutoring is delivered through <strong>1-on-1 or group online sessions</strong>, guided by expert Year 5 NAPLAN Maths tutors who focus on real progress.",
            term:{
                    topics: [
                        {
                            name: "Whole Numbers & Place Value",
                            description: "Reading/ordering whole numbers, number sentences, mental addition/subtraction, interpreting place value in word problems."
                        },
                        {
                            name: "Multiplication & Division Fluency",
                            description: "Times tables (up to 10×10), division facts, equal sharing, multi-step operations, missing number equations."
                        },
                        {
                            name: "Fractions – Part-Whole & Number Line",
                            description: "Fraction-of-a-collection, shapes, equivalence, simple comparison, locating fractions on number lines."
                        },
                        {
                            name: "Decimals & Money",
                            description: "Tenths/hundredths, decimal–fraction link, calculating change, totals, money word problems."
                        },
                        {
                            name: "Mixed Operations & Word Problems",
                            description: "Multi-step NAPLAN-style reasoning tasks combining +, –, ×, ÷ with contextual situations (ages, distances, objects, items)."
                        },
                        {
                            name: "Patterns, Factors & Multiples",
                            description: "Numeric patterns, rules, skip counting, identifying factors/multiples, divisibility reasoning."
                        },
                        {
                            name: "Fractions–Decimals–Percentages (Combined)",
                            description: "Converting between formats, familiar percentages (10%, 25%, 50%), simple fractional addition/subtraction."
                        },
                        {
                            name: "Perimeter, Area, Length, Volume & Capacity",
                            description: "Perimeter of composite shapes, area grids, measuring amounts poured/remaining, reading scales/jugs."
                        },
                        {
                            name: "Time, Timetables & Temperature",
                            description: "Reading analogue/digital clocks, elapsed time, timetables, duration problems, thermometer readings."
                        },
                        {
                            name: "Geometry – Shapes, Nets, Angles, Symmetry",
                            description: "2D/3D shapes, nets, estimating angles, reflections, rotations, identifying shapes from views."
                        },
                        {
                            name: "Data Representation (Tables, Graphs, Dot Plots)",
                            description: "Reading column graphs, dot plots, tallies; “how many more”, total, interpretation questions."
                        },
                        {
                            name: "Chance & Comprehensive Revision Test",
                            description: "Likelihood, spinner outcomes, most/least likely events plus a mixed NAPLAN-style review test."
                        },
                    ]
                },
            ...
            sidebar: {
                ...
                subtitle: "Personalised Online Tutoring by trained teachers familiar with the Australian curriculum Year 5 NAPLAN Maths, trusted by parents looking for the best Year 5 NAPLAN Maths tutor Australia wide.",
                buttonText: "Book Your Free Trial Class",
                buttonLink: "/contact",
                "keyAreas": [
                            "Number Sense and Operations",
                ...
                description: "All topics align with Australian Curriculum Maths Year 5 and are taught by experienced Year 5 NAPLAN Maths tutors."
            },
        
        },
        "english": {
            pageTitle: "Year 5 NAPLAN English – Personalised Online Tutoring",
            introHeading: "We've Got the Curriculum Covered",
    ...
    "year-7": {
        "maths": {
            ...
            introHeading: "We've Got the Curriculum Covered",
            introP1: "At TutorExel, our Year 7 NAPLAN Maths program builds a strong foundation in number skills, operations, early fractions, and patterns. Lessons are tailored to your child’s pace and aligned with the Australian Curriculum Year 7 NAPLAN Maths.",
            introP2: "Tutoring is delivered through <strong>1-on-1 or group online sessions</strong>, guided by expert Year 7 NAPLAN Maths tutors who focus on real progress.",
            term:{
                    topics: [
                        {
                            name: "Number Sense & Whole Number Operations",
                            description: "Place value, mental maths, rounding, order of operations, integer arithmetic, prime & composite numbers (small insert)."
                        },
                        {
                            name: "Fractions: Equivalence, Simplification & Fraction of Quantities",
                            description: "Equivalent fractions, simplification, comparing fractions, fraction of number problems, percentage-of-quantity warm-ups."
                        },
                        {
                            name: "Decimals & Percentages: Operations and Conversions",
                            description: "Decimal operations, FDP conversions, percentage discounts/increase, basic negative number number-line skills."
                        },
                        {
                            name: "Ratio & Proportion",
                            description: "Ratio, rates, proportional problems, ratio–percentage link (small insert)."
                        },
                        {
                            name: "Algebra & Patterns",
                            description: "Algebraic expressions, equations, patterns, prime factorisation, LCM/HCF, powers of 10 (small insert)."
                        },
                        {
                            name: "Coordinates, Graphs & Data Interpretation",
                            description: "Cartesian plane, bar graphs, tables, line graphs, dot plots."
                        },
                        {
                            name: "Measurement I: Length, Perimeter & Area",
                            description: "Area & perimeter of rectangles, triangles, parallelograms; composite shapes."
                        },
                        {
                            name: "Measurement II: Volume, Capacity & Unit Conversions",
                            description: "Volume of prisms, reading scales, capacity/mass conversions."
                        },
                        {
                            name: "Measurement III: Time, Timetables, Duration & Rates",
                            description: "Time calculations, timetables, speed, multi-step rate problems."
                        },
                        {
                            name: "Geometry I: Shapes, Angles, Symmetry & Transformations",
                            description: "Angles, triangles, symmetry, reflections, rotations."
                        },
                        {
                            name: "Geometry II: Nets, 3D Shapes, Views & Spatial Reasoning",
                            description: "Nets of solids, top/front/side views, cube stacks, spatial reasoning."
                        },
                        {
                            name: "Probability & Chance",
                            description: "Spinners, dice, likelihood, combined outcomes."
                        },
                    ]
                },
            ...
            sidebar: {
                ...
                subtitle: "Personalised Online Tutoring by trained teachers familiar with the Australian curriculum Year 7 NAPLAN Maths, trusted by parents looking for the best Year 7 NAPLAN Maths tutor Australia wide.",
                buttonText: "Book Your Free Trial Class",
                buttonLink: "/contact",
                "keyAreas": [
                            "Number Sense and Operations",
                ...
                description: "All topics align with Australian Curriculum Maths Year 7 and are taught by experienced Year 7 NAPLAN Maths tutors."
            },
        
        },
        "english": {
            pageTitle: "Year 7 NAPLAN English – Personalised Online Tutoring",
            introHeading: "We've Got the Curriculum Covered",
    ...
    "year-9": {
        "maths": {
            ...
            introHeading: "We've Got the Curriculum Covered",
            introP1: "At TutorExel, our Year 9 NAPLAN Maths program builds a strong foundation in number skills, operations, early fractions, and patterns. Lessons are tailored to your child’s pace and aligned with the Australian Curriculum Year 9 NAPLAN Maths.",
            introP2: "Tutoring is delivered through <strong>1-on-1 or group online sessions</strong>, guided by expert Year 9 NAPLAN Maths tutors who focus on real progress.",
            term:{
                    topics: [
                        {
                            name: "Real Numbers, Indices & Scientific Notation",
                            description: "Understanding real numbers, surds, index laws, and scientific notation with a focus on estimation and real-world interpretation."
                        },
                        {
                            name: "Patterns, Sequences & Algebraic Rules",
                            description: "Identifying patterns, forming algebraic rules, and working forwards and backwards using tables and visual sequences."
                        },
                        {
                            name: "Linear Expressions & Simplification",
                            description: "Simplifying, expanding, and factorising linear expressions by recognising equivalent forms and common NAPLAN traps."
                        },
                        {
                            name: "Linear Equations & Rearranging Formulas",
                            description: "Solving one-step and multi-step equations and rearranging formulas in practical problem contexts."
                        },
                        {
                            name: "Graphs, Coordinates & Transformations",
                            description: "Interpreting graphs, plotting points, and analysing translations, reflections, and rotations through visual reasoning."
                        },
                        {
                            name: "Ratios, Rates & Proportional Reasoning",
                            description: "Applying ratios, rates, and scale factors to real-life situations such as speed, maps, recipes, and pricing."
                        },
                        {
                            name: "Percentages & Financial Mathematics",
                            description: "Working with percentage change, discounts, best buys, and budgeting using comparison and estimation strategies."
                        },
                        {
                            name: "Measurement, Units & Estimation",
                            description: "Estimating and calculating length, area, volume, time, and mass, including unit conversions and composite shapes."
                        },
                        {
                            name: "Geometry: Properties, Angles & Shape Reasoning",
                            description: "Recognising angle relationships, shape properties, symmetry, nets, and 3D objects through visual analysis."
                        },
                        {
                            name: "Pythagoras, Circles & Scale",
                            description: "Applying Pythagoras’ theorem, circle measurements, and scale drawings to real-world distance and map problems."
                        },
                        {
                            name: "Data Representation & Interpretation",
                            description: "Reading tables and graphs, comparing data sets, and interpreting averages and trends."
                        },
                        {
                            name: "Probability, Logic & NAPLAN Exam Strategy",
                            description: "Solving probability problems using logic, tables, and diagrams, plus exam strategies, estimation, and trap avoidance."
                        },
                    ]
                },
            ...
            sidebar: {
                ...
                subtitle: "Personalised Online Tutoring by trained teachers familiar with the Australian curriculum Year 9 NAPLAN Maths, trusted by parents looking for the best Year 9 NAPLAN Maths tutor Australia wide.",
                buttonText: "Book Your Free Trial Class",
                buttonLink: "/contact",
                "keyAreas": [
                            "Number Sense and Operations",
                ...
                description: "All topics align with Australian Curriculum Maths Year 9 and are taught by experienced Year 9 NAPLAN Maths tutors."
            },
        
        },
        "english": {
            pageTitle: "Year 9 NAPLAN English – Personalised Online Tutoring",
            introHeading: "We've Got the Curriculum Covered",
