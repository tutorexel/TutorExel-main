...
const TermPage = () => {
    ...
    return (
                        ...
                        <Col lg={12} className="mx-auto">
                            ...
                            <Card.Body>
                                <div className="blog-content">
                                    ...
                                    <p>Welcome to <strong>TutorExel</strong> (“we”, “us”, “our”). TutorExel operates under <strong>TutorExel LLP</strong>, providing online tutoring and enrichment programs for students across various subjects and skill areas.</p>
        ...
        <p>All course content, lesson materials, slides, worksheets, recordings, reports, and designs are the <b>exclusive intellectual property</b> of TutorExel LLP. <br />
